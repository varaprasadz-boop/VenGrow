        ...
        <Card className="p-6 sm:p-8">
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="flex items-start space-x-2">
              <Checkbox id="terms" data-testid="checkbox-terms" required />
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button variant="outline" type="button" data-testid="button-google">
              ...
              <Button variant="outline" type="button" data-testid="button-github">
