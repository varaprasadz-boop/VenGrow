...
export default function FormInquiriesPage() {
  ...
  const filteredInquiries = formInquiries.filter(inquiry =>
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Inquiries submitted via property forms</p>
              </div>
            </div>
        ...
        <Dialog open={!!selectedInquiry} onOpenChange={(open) => !open && setSelectedInquiry(null)}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                View details for this form inquiry
              </DialogDescription>
            </DialogHeader>
            {selectedInquiry && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="bg-muted/50 p-4 rounded-lg space-y-2">
                    ...
                    {(selectedInquiry as any).buyerPhone && (
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                        <Phone className="h-3 w-3" />
                        <span>{(selectedInquiry as any).buyerPhone}</span>
                      </div>
                    )}
                  </div>
                </div>
