    ...
    <SellerLayout>
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <Button asChild>
            <Link href="/seller/select-form" data-testid="button-add-property">
          ...
          <CardContent>
            <div className="grid gap-3 md:grid-cols-4">
              <Button variant="outline" asChild className="h-auto py-4">
                <Link href="/seller/select-form" data-testid="button-quick-add-property" className="flex flex-col items-center gap-2">
