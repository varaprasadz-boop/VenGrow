...
export default function TermsPage() {
  const { data: pageContent, isLoading, isError } = useQuery<StaticPage>({
    queryKey: ["/api/static-pages", "terms"],
    staleTime: 5 * 60 * 1000,
  });
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <Card className="p-8 text-center">
                ...
                <p className="text-muted-foreground">
                  Terms of Service content has not been configured yet. Please check back later.
                </p>
              </Card>
            </div>
          </section>
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="py-16 bg-gradient-to-b from-primary/5 to-background" data-testid="section-terms-hero">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <Badge className="mb-4">Legal</Badge>
            <h1 className="font-serif font-bold text-4xl sm:text-5xl mb-6" data-testid="text-terms-title">
              {pageContent.title || "Terms of Service"}
            </h1>
            {pageContent.lastUpdated && (
              <p className="text-muted-foreground" data-testid="text-terms-date">
        ...
        <section className="py-16" data-testid="section-terms-content">
          <div 
