...
export const sellerRoutes: RouteConfig[] = [
  ...
  { path: "/seller/property/add", component: lazy(() => import("@/pages/seller/SelectFormPage")), requireAuth: true, roles: ["seller"], title: "Select Property Type" },
  ...
  { path: "/seller/create-property", component: lazy(() => import("@/pages/seller/SelectFormPage")), requireAuth: true, roles: ["seller"], title: "Select Property Type" },
  { path: "/seller/create-listing", component: lazy(() => import("@/pages/seller/SelectFormPage")), requireAuth: true, roles: ["seller"], title: "Select Property Type" },
