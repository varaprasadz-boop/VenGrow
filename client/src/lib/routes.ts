...
export const sellerRoutes: RouteConfig[] = [
  ...
  { path: "/seller/approval-approved", component: lazy(() => import("@/pages/seller/ApprovalApprovedPage")), requireAuth: true, roles: ["seller", "admin"], title: "Approved" },
  { path: "/seller/approval-rejected", component: lazy(() => import("@/pages/seller/ApprovalRejectedPage")), requireAuth: true, roles: ["seller", "admin"], title: "Rejected" },
  ...
  { path: "/seller/listings/edit/:id", component: lazy(() => import("@/pages/seller/CreatePropertyPage")), requireAuth: true, roles: ["seller", "admin"], title: "Edit Property" },
  { path: "/seller/properties/edit/:id", component: lazy(() => import("@/pages/seller/CreatePropertyPage")), requireAuth: true, roles: ["seller", "admin"], title: "Edit Property" },
  ...
  { path: "/seller/listings/create/step1", component: lazy(() => import("@/pages/seller/CreateListingStep1Page")), requireAuth: true, roles: ["seller", "admin"], title: "Create Listing - Step 1" },
  { path: "/seller/listings/create/step2", component: lazy(() => import("@/pages/seller/CreateListingStep2Page")), requireAuth: true, roles: ["seller", "admin"], title: "Create Listing - Step 2" },
  { path: "/seller/listings/create/step3", component: lazy(() => import("@/pages/seller/CreateListingStep3Page")), requireAuth: true, roles: ["seller", "admin"], title: "Create Listing - Step 3" },
  { path: "/seller/listings/create/step4", component: lazy(() => import("@/pages/seller/CreateListingStep4Page")), requireAuth: true, roles: ["seller", "admin"], title: "Create Listing - Step 4" },
  ...
  { path: "/seller/create-listing/step4", component: lazy(() => import("@/pages/seller/CreateListingStep4Page")), requireAuth: true, roles: ["seller", "admin"], title: "Create Listing - Step 4" },
  { path: "/seller/property/:id/photos", component: lazy(() => import("@/pages/seller/PropertyPhotosPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Photos" },
  { path: "/seller/property/:id/media", component: lazy(() => import("@/pages/seller/PropertyMediaPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Media" },
  { path: "/seller/property/:id/status", component: lazy(() => import("@/pages/seller/PropertyStatusPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Status" },
  { path: "/seller/property/:id/insights", component: lazy(() => import("@/pages/seller/PropertyInsightsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Insights" },
  { path: "/seller/property/:id/archive", component: lazy(() => import("@/pages/seller/PropertyArchivePage")), requireAuth: true, roles: ["seller", "admin"], title: "Archive Property" },
  { path: "/seller/property/:id/archived", component: lazy(() => import("@/pages/seller/PropertyArchivedPage")), requireAuth: true, roles: ["seller", "admin"], title: "Archived Properties" },
  { path: "/seller/property/:id/duplicate", component: lazy(() => import("@/pages/seller/PropertyDuplicatePage")), requireAuth: true, roles: ["seller", "admin"], title: "Duplicate Property" },
  { path: "/seller/property/:id/clone", component: lazy(() => import("@/pages/seller/PropertyClonePage")), requireAuth: true, roles: ["seller", "admin"], title: "Clone Property" },
  { path: "/seller/property/:id/renewal", component: lazy(() => import("@/pages/seller/PropertyRenewalPage")), requireAuth: true, roles: ["seller", "admin"], title: "Renew Listing" },
  { path: "/seller/property/:id/expiry", component: lazy(() => import("@/pages/seller/PropertyExpiryPage")), requireAuth: true, roles: ["seller", "admin"], title: "Listing Expiry" },
  { path: "/seller/property/:id/boost", component: lazy(() => import("@/pages/seller/PropertyBoostPage")), requireAuth: true, roles: ["seller", "admin"], title: "Boost Listing" },
  { path: "/seller/property/:id/promotion", component: lazy(() => import("@/pages/seller/PropertyPromotionPage")), requireAuth: true, roles: ["seller", "admin"], title: "Promote Listing" },
  { path: "/seller/property/:id/branding", component: lazy(() => import("@/pages/seller/PropertyBrandingPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Branding" },
  { path: "/seller/property/:id/seo", component: lazy(() => import("@/pages/seller/PropertySEOPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property SEO" },
  { path: "/seller/property/:id/tags", component: lazy(() => import("@/pages/seller/PropertyTagsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Tags" },
  { path: "/seller/property/:id/rating", component: lazy(() => import("@/pages/seller/PropertyRatingPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Rating" },
  { path: "/seller/property/:id/feedback", component: lazy(() => import("@/pages/seller/PropertyFeedbackPage")), requireAuth: true, roles: ["seller", "admin"], title: "Property Feedback" },
  { path: "/seller/property/:id/schedule", component: lazy(() => import("@/pages/seller/PropertySchedulePage")), requireAuth: true, roles: ["seller", "admin"], title: "Viewing Schedule" },
  { path: "/seller/property/:id/sold", component: lazy(() => import("@/pages/seller/PropertySoldPage")), requireAuth: true, roles: ["seller", "admin"], title: "Mark as Sold" },
  { path: "/seller/property/:id/export", component: lazy(() => import("@/pages/seller/PropertyExportPage")), requireAuth: true, roles: ["seller", "admin"], title: "Export Property" },
  { path: "/seller/property/:id/performance", component: lazy(() => import("@/pages/seller/PropertyPerformanceReportPage")), requireAuth: true, roles: ["seller", "admin"], title: "Performance Report" },
  { path: "/seller/bulk-upload", component: lazy(() => import("@/pages/seller/BulkUploadPage")), requireAuth: true, roles: ["seller", "admin"], title: "Bulk Upload" },
  { path: "/seller/listing-settings", component: lazy(() => import("@/pages/seller/ListingSettingsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Listing Settings" },
  { path: "/seller/documents", component: lazy(() => import("@/pages/seller/DocumentsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Documents" },
  ...
  { path: "/seller/visits", component: lazy(() => import("@/pages/seller/AppointmentsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Scheduled Visits" },
  { path: "/seller/appointments", component: lazy(() => import("@/pages/seller/AppointmentsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Appointments" },
  ...
  { path: "/seller/lead-sources", component: lazy(() => import("@/pages/seller/LeadSourcesPage")), requireAuth: true, roles: ["seller", "admin"], title: "Lead Sources" },
  { path: "/seller/messages", component: lazy(() => import("@/pages/seller/MessagesPage")), requireAuth: true, roles: ["seller", "admin"], title: "Messages" },
  ...
  // Marketing & Promotion
  { path: "/seller/marketing-campaigns", component: lazy(() => import("@/pages/seller/MarketingCampaignsPage")), requireAuth: true, roles: ["seller", "admin"], title: "Marketing Campaigns" },
  { path: "/seller/social-media", component: lazy(() => import("@/pages/seller/SocialMediaIntegrationPage")), requireAuth: true, roles: ["seller", "admin"], title: "Social Media" },
  { path: "/seller/referral-program", component: lazy(() => import("@/pages/seller/ReferralProgramPage")), requireAuth: true, roles: ["seller", "admin"], title: "Referral Program" },
  { path: "/seller/referral-dashboard", component: lazy(() => import("@/pages/seller/ReferralDashboardPage")), requireAuth: true, roles: ["seller", "admin"], title: "Referral Dashboard" },
];
