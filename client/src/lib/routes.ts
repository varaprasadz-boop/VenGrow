...
export const sellerRoutes: RouteConfig[] = [
  ...
  { path: "/seller/create-property", component: lazy(() => import("@/pages/seller/SelectFormPage")), requireAuth: true, roles: ["seller"], title: "Create Property" },
  { path: "/seller/create-listing", component: lazy(() => import("@/pages/seller/SelectFormPage")), requireAuth: true, roles: ["seller"], title: "Create Listing" },
